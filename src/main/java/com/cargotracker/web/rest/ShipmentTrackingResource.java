...
public class ShipmentTrackingResource {
     ...
     *
     * @param shipmentTrackingDTO the shipmentTrackingDTO to create
     * @return the ResponseEntity with status 201 (Created) and with body the new shipmentTrackingDTO, or with status 400 (Bad Request) if the shipmentTracking has already an ID
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PostMapping("/shipment-trackings")
    public ResponseEntity<ShipmentTrackingDTO> createShipmentTracking(@Valid @RequestBody ShipmentTrackingDTO shipmentTrackingDTO) throws URISyntaxException {
     ...
     *
     * @param shipmentTrackingDTO the shipmentTrackingDTO to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated shipmentTrackingDTO,
     * or with status 400 (Bad Request) if the shipmentTrackingDTO is not valid,
     * or with status 500 (Internal Server Error) if the shipmentTrackingDTO couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/shipment-trackings")
    public ResponseEntity<ShipmentTrackingDTO> updateShipmentTracking(@Valid @RequestBody ShipmentTrackingDTO shipmentTrackingDTO) throws URISyntaxException {
     ...
     *
     * @param id the id of the shipmentTrackingDTO to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the shipmentTrackingDTO, or with status 404 (Not Found)
     */
     ...
     *
     * @param id the id of the shipmentTrackingDTO to delete
