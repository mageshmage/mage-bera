...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.cargotracker.domain.UserExtra.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.cargotracker.domain.ShipmentInfo.class.getName() + ".shipmentTrackings", jcacheConfiguration);
            ...
            cm.createCache(com.cargotracker.domain.ShipmentTracking.class.getName(), jcacheConfiguration);
