...
import { createEntityBulk, reset } from 'app/modules/shipmentinformation/shipment-information.reducer';

export interface IShipmentInformationBulkProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export interface IShipmentInformationBulkState {
  isNew: boolean;
...
export class ShipmentInformationBulk extends React.Component<IShipmentInformationBulkProps, IShipmentInformationBulkState> {
  constructor(props) {
    super(props);
    this.state = {
      shipmentInfoId: '0',
  ...
  render() {
    const { loading, updating, bulkResponse } = this.props;

    return (
      <div>
        <Row className="justify-content-center">
          <Col md="12">
            <h2 id="cargotrackerApp.shipmentInfoPOD.home.titleBulk" className="cargoTitle">
              <Translate contentKey="cargotrackerApp.shipmentInfo.home.titleBulk">Create Shipment Bulk</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  bulkResponse: storeState.shipmentInformation.bulkResponse
});
