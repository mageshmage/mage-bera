    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="12">
            <h2 id="cargotrackerApp.shipmentInfo..detail.title" className="cargotracker-header cargotracker-textalign-center">
              <Translate contentKey="cargotrackerApp.shipmentInfo.detail.title">Shipment Information Details</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
