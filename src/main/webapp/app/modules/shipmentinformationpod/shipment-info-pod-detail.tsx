    ...
    return (
      <Row>
        <Col md="8">
          ...
          <Button tag={Link} to="/shipment-information-pod" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/shipment-information-pod/${shipmentInfoPODEntity.id}/edit`} replace color="primary">
