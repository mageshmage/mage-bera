                ...
                <div className={classes.container}>
                    ...
                    <div className={classes.textCenter}>
                        ...
                        <Button color="twitter" href=""
                            target="_blank">
                            <i className={classes.socials + " fas fa-envelope-open"} /> godeliverncr@gmail.com
                </Button>
        </div>*/}
                    <div className={classes.textCenter}>

                        <Button color="primary" href="https://www.linkedin.com/in/godeliver-ncr-04b27218b/"
                            target="_blank">
                            <i className={classes.socials + " fab fa-linkedin"} /> Linkedin
            </Button>
                        <Button color="twitter" href="https://twitter.com/NcrGo"
                            target="_blank">
                            <i className={classes.socials + " fab fa-twitter"} /> Tweet
            </Button>
                        <Button color="facebook" href="https://www.facebook.com/godeliverncrind/"
                            target="_blank">
                            <i className={classes.socials + " fab fa-facebook-square"} />{" "}
                            Share
            </Button>
                        <Button color="success" href="http://godeliverncr.in"
                            target="_blank">
