          ...
          <GridContainer justify="center">
            <GridItem xs={12} sm={12} md={6}>
              <div className={classes.profile}>
                ...
                <b className={classes.goBold}>Go Deliver IND</b> are currently looking for Full & Part Time drivers to join their expanding business, 
                experience and skilled person required, <b className={classes.goBold}>minimum age 21</b>, please apply using our contact us page.
                </p>
