          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('otherCity')}>
            ...
            <tbody>
              {shiperReceiverInfoList.map((shiperReceiverInfo, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{shiperReceiverInfo.otherCity}</td>
                  <td>{shiperReceiverInfo.pincode}</td>
                  <td>{shiperReceiverInfo.emailId}</td>
                  <td>
                    {shiperReceiverInfo.city ? <Link to={`city/${shiperReceiverInfo.city.id}`}>{shiperReceiverInfo.city.id}</Link> : ''}
                  </td>
                  <td>
