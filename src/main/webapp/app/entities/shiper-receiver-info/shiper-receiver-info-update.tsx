...
export class ShiperReceiverInfoUpdate extends React.Component<IShiperReceiverInfoUpdateProps, IShiperReceiverInfoUpdateState> {
  ...
  render() {
    const { shiperReceiverInfoEntity, cities, shipmentInfos, loading, updating } = this.props;
              ...
              <AvForm model={isNew ? {} : shiperReceiverInfoEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput
                    ...
                    name="type"
                    value={(!isNew && shiperReceiverInfoEntity.type) || 'SHIPPER'}
                  >
                    <option value="SHIPPER">
                      <Translate contentKey="cargotrackerApp.ShiperReceiverType.SHIPPER" />
                    </option>
                    <option value="RECEIVER">
                      <Translate contentKey="cargotrackerApp.ShiperReceiverType.RECEIVER" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  <Label id="otherCityLabel" for="otherCity">
                    <Translate contentKey="cargotrackerApp.shiperReceiverInfo.otherCity">Other City</Translate>
                  </Label>
                  <AvField id="shiper-receiver-info-otherCity" type="text" name="otherCity" />
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvInput id="shiper-receiver-info-city" type="select" className="form-control" name="city.id">
                    <option value="" key="0" />
                    {cities
