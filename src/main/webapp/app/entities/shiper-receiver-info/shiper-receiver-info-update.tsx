              ...
              <AvForm model={isNew ? {} : shiperReceiverInfoEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput
                    ...
                    name="type"
                    value={(!isNew && shiperReceiverInfoEntity.type) || 'CONSIGNOR'}
                  >
                    <option value="CONSIGNOR">
                      <Translate contentKey="cargotrackerApp.ShiperReceiverType.CONSIGNOR" />
                    </option>
                    <option value="CONSIGNEE">
                      <Translate contentKey="cargotrackerApp.ShiperReceiverType.CONSIGNEE" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                ...
                <AvGroup>
                  ...
                  <AvField id="shiper-receiver-info-city" type="text" name="city" />
                </AvGroup>
                <AvGroup>
