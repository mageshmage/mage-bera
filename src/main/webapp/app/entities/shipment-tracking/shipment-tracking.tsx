...
import { getSearchEntities, getEntities } from './shipment-tracking.reducer';
...
export class ShipmentTracking extends React.Component<IShipmentTrackingProps, IShipmentTrackingState> {
  ...
  render() {
    const { shipmentTrackingList, match, totalItems } = this.props;
    return (
      <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('trackingDate')}>
                ...
                <th className="hand" onClick={this.sort('place')}>
                  <Translate contentKey="cargotrackerApp.shipmentTracking.place">Place</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="cargotrackerApp.shipmentTracking.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {shipmentTrackingList.map((shipmentTracking, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={shipmentTracking.trackingDate} format={APP_DATE_FORMAT} />
                  </td>
...
const mapStateToProps = ({ shipmentTracking }: IRootState) => ({
  shipmentTrackingList: shipmentTracking.entities,
  totalItems: shipmentTracking.totalItems
});
