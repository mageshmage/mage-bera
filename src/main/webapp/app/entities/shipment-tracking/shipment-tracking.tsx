          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('activities')}>
                  <Translate contentKey="cargotrackerApp.shipmentTracking.activities">Activities</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {shipmentTrackingList.map((shipmentTracking, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{shipmentTracking.activities}</td>
                  <td>
