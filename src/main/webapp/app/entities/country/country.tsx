    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="cargotrackerApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="cargotrackerApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('cargotrackerApp.country.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="cargotrackerApp.country.countryCode">Country Code</Translate>
                </th>
                <th>
                  <Translate contentKey="cargotrackerApp.country.countryName">Country Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
