...
import { getEntity, updateEntity, createEntity, setBlob, reset } from './shipment-info-pod.reducer';
...
export class ShipmentInfoPODUpdate extends React.Component<IShipmentInfoPODUpdateProps, IShipmentInfoPODUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/entity/shipment-info-pod');
  };
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : shipmentInfoPODEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="shipment-info-pod-shipmentInfo" type="select" className="form-control" name="shipmentInfo.id">
                    <option value="" key="0" />
                    {shipmentInfos
                ...
                <Button tag={Link} id="cancel-save" to="/entity/shipment-info-pod" replace color="info">
...
const mapStateToProps = (storeState: IRootState) => ({
  ...
  shipmentInfoPODEntity: storeState.shipmentInfoPOD.entity,
  loading: storeState.shipmentInfoPOD.loading,
  updating: storeState.shipmentInfoPOD.updating,
  updateSuccess: storeState.shipmentInfoPOD.updateSuccess
});
