...
import { getSearchEntities, getEntities } from './shipment-info-pod.reducer';
...
export class ShipmentInfoPOD extends React.Component<IShipmentInfoPODProps, IShipmentInfoPODState> {
  ...
  render() {
    const { shipmentInfoPODList, match } = this.props;
    return (
      <div>
...
const mapStateToProps = ({ shipmentInfoPOD }: IRootState) => ({
  shipmentInfoPODList: shipmentInfoPOD.entities
});
