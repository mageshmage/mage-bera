...
describe('ShipmentTracking e2e test', () => {
  ...
  it('should create and save ShipmentTrackings', async () => {
    ...
    await shipmentTrackingUpdatePage.setPlaceInput('place');
    expect(await shipmentTrackingUpdatePage.getPlaceInput()).to.match(/place/);
    await shipmentTrackingUpdatePage.setStatusInput('status');
    expect(await shipmentTrackingUpdatePage.getStatusInput()).to.match(/status/);
