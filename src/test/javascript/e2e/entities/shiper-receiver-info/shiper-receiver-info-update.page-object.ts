...
export default class ShiperReceiverInfoUpdatePage {
  ...
  otherCityInput: ElementFinder = element(by.css('input#shiper-receiver-info-otherCity'));
  ...
  async setOtherCityInput(otherCity) {
    await this.otherCityInput.sendKeys(otherCity);
  }

  async getOtherCityInput() {
    return this.otherCityInput.getAttribute('value');
  }
