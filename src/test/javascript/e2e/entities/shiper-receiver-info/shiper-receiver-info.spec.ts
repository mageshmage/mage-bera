...
describe('ShiperReceiverInfo e2e test', () => {
  ...
  it('should create and save ShiperReceiverInfos', async () => {
    ...
    await shiperReceiverInfoUpdatePage.setShipperNameInput('shipperName');
    expect(await shiperReceiverInfoUpdatePage.getShipperNameInput()).to.match(/shipperName/);
    ...
    await shiperReceiverInfoUpdatePage.setOtherCityInput('otherCity');
    expect(await shiperReceiverInfoUpdatePage.getOtherCityInput()).to.match(/otherCity/);
    ...
    await shiperReceiverInfoUpdatePage.citySelectLastOption();
