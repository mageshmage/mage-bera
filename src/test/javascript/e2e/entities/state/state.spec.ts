...
describe('State e2e test', () => {
  ...
  it('should load create State page', async () => {
    ...
    expect(await stateUpdatePage.getPageTitle().getAttribute('id')).to.match(/cargotrackerApp.state.home.createOrEditLabel/);
  });
  ...
  it('should delete last State', async () => {
    ...
    expect(await stateDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/cargotrackerApp.state.delete.question/);
