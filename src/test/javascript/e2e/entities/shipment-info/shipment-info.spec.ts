...
describe('ShipmentInfo e2e test', () => {
  ...
  it('should create and save ShipmentInfos', async () => {
    ...
    await shipmentInfoUpdatePage.carrierSelectLastOption();
    ...
    await shipmentInfoUpdatePage.setOriginInput('origin');
    expect(await shipmentInfoUpdatePage.getOriginInput()).to.match(/origin/);
    await shipmentInfoUpdatePage.setDestinationInput('destination');
    expect(await shipmentInfoUpdatePage.getDestinationInput()).to.match(/destination/);
    ...
    await shipmentInfoUpdatePage.statusSelectLastOption();
