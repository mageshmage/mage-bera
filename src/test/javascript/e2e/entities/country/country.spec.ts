...
describe('Country e2e test', () => {
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle().getAttribute('id')).to.match(/cargotrackerApp.country.home.createOrEditLabel/);
  });
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/cargotrackerApp.country.delete.question/);
