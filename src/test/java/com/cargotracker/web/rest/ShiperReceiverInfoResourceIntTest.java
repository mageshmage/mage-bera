...
public class ShiperReceiverInfoResourceIntTest {
    ...
    private static final ShiperReceiverType DEFAULT_TYPE = ShiperReceiverType.DOCUMENT;
    private static final ShiperReceiverType UPDATED_TYPE = ShiperReceiverType.PARCEL;
    ...
    public void checkCityIsRequired() throws Exception {
        int databaseSizeBeforeTest = shiperReceiverInfoRepository.findAll().size();
        // set the field null
        shiperReceiverInfo.setCity(null);
