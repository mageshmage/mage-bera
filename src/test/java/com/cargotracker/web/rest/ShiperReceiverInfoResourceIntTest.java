...
public class ShiperReceiverInfoResourceIntTest {
    ...
    private static final ShiperReceiverType DEFAULT_TYPE = ShiperReceiverType.SHIPPER;
    private static final ShiperReceiverType UPDATED_TYPE = ShiperReceiverType.RECEIVER;
    ...
    private static final String DEFAULT_OTHER_CITY = "AAAAAAAAAA";
    private static final String UPDATED_OTHER_CITY = "BBBBBBBBBB";
    ...
    public void createShiperReceiverInfo() throws Exception {
        ...
        assertThat(testShiperReceiverInfo.getShipperName()).isEqualTo(DEFAULT_SHIPPER_NAME);
        ...
        assertThat(testShiperReceiverInfo.getOtherCity()).isEqualTo(DEFAULT_OTHER_CITY);
    ...
    public void checkShipperNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = shiperReceiverInfoRepository.findAll().size();
        // set the field null
        shiperReceiverInfo.setShipperName(null);
    ...
    public void getAllShiperReceiverInfos() throws Exception {
        ...
        restShiperReceiverInfoMockMvc.perform(get("/api/shiper-receiver-infos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].otherCity").value(hasItem(DEFAULT_OTHER_CITY.toString())))
    ...
    public void getShiperReceiverInfo() throws Exception {
        ...
        restShiperReceiverInfoMockMvc.perform(get("/api/shiper-receiver-infos/{id}", shiperReceiverInfo.getId()))
            ...
            .andExpect(jsonPath("$.otherCity").value(DEFAULT_OTHER_CITY.toString()))
    ...
    public void updateShiperReceiverInfo() throws Exception {
        ...
        assertThat(testShiperReceiverInfo.getShipperName()).isEqualTo(UPDATED_SHIPPER_NAME);
        ...
        assertThat(testShiperReceiverInfo.getOtherCity()).isEqualTo(UPDATED_OTHER_CITY);
    ...
    public void searchShiperReceiverInfo() throws Exception {
        ...
        restShiperReceiverInfoMockMvc.perform(get("/api/_search/shiper-receiver-infos?query=id:" + shiperReceiverInfo.getId()))
            ...
            .andExpect(jsonPath("$.[*].otherCity").value(hasItem(DEFAULT_OTHER_CITY)))
