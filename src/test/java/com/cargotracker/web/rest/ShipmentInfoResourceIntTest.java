...
public class ShipmentInfoResourceIntTest {
    ...
    public void createShipmentInfo() throws Exception {
        ...
        assertThat(testShipmentInfo.getOrigin()).isEqualTo(DEFAULT_ORIGIN);
        assertThat(testShipmentInfo.getDestination()).isEqualTo(DEFAULT_DESTINATION);
    ...
    public void checkDestinationIsRequired() throws Exception {
        int databaseSizeBeforeTest = shipmentInfoRepository.findAll().size();
        // set the field null
        shipmentInfo.setDestination(null);
    ...
    public void updateShipmentInfo() throws Exception {
        ...
        assertThat(testShipmentInfo.getOrigin()).isEqualTo(UPDATED_ORIGIN);
        assertThat(testShipmentInfo.getDestination()).isEqualTo(UPDATED_DESTINATION);
